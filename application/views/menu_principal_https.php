        ...
        <div class="container">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle"><i class="fa fa-align-justify fa-lg"></i></button>
              <a href="<?php echo url_https(base_url()); ?>" class="navbar-brand">
                  <img src="<?php echo url_https(base_url()); ?>assets/img/logo_Main.png" style="width:140px;padding:10px" class="logo-white">
                  <img src="<?php echo url_https(base_url()); ?>assets/img/logo-dark.png" alt="" class="logo-dark" style="padding:10px">
              </a>
          </div>
                       ...
                       <div aria-labelledby="dropdownMenuLogin" class="dropdown-menu widget-box">
                        <form>
                            ...
                            <div class="form-inline form-group" style="text-align:center">
                                <a href="<?php echo url_https(base_url()); ?>index.php/Registro" class="btn btn-primary btn-xs">Registrarse</a>
                                
                                <a id="inicia_sesion" name="inicia_sesion" type="button" class="btn btn-primary btn-xs">Iniciar Sesión</a>
                            </div><center><a href="<?php echo url_https(base_url()); ?>index.php/Registro/recoveryLogin"><small>¿Olvidaste tu contraseña?</small></a></center>
                        </form>
                   </div>
                    <?php }else{ ?>
...
<!--                            <div class="form-group"><label class="sr-only">Usuario</label></div>-->
                            <div class="form-group">
                                <center><a  class="btn btn-primary btn-xs"  href="<?php echo url_https(base_url()); ?>index.php/Perfil/editPerfil">Perfil</a></center>
                            </div>
                            <div class="form-inline form-group" style="text-align:center">
            ...
            <ul id="one-page-menu" role="menu" class="nav navbar-nav navbar-left" style="font-size:10px">
              ...
              <li><a href="<?php echo url_https(base_url()); ?>index.php/Admin/productos" title="Home" data-ref="principal">Administración</a></li>
                <?php } ?>
                
<!--              <li><a href="<?php echo url_https(base_url()); ?>" title="Home" data-ref="principal">Home</a></li>-->
<!--                <li><a href="<?php echo url_https(base_url()); ?>index.php/nosotros" title="Nosotros">Nosotros</a></li>-->
                <?php if($this->session->userdata('us3r_cl1ent_v4r')!=''  | $this->session->userdata('admin_var')!=''){ ?>
					<li><a href="<?php echo url_https(base_url()); ?>index.php/galeria" title="Productos">Productos</a></li>
                <?php }else{ ?>
              ...
              <li><a href="<?php echo url_https(base_url()); ?>#pricing" title="Puntos de venta" data-ref="pricing">Puntos de venta</a></li>
              <li><a href="<?php echo url_https(base_url()); ?>#portfolio" title="Interiorismo" data-ref="portfolio">Interiorismo</a></li>
              ...
              <li><a href="<?php echo url_https(base_url()); ?>#contacts" title="Contacto" data-ref="contacts">Contacto</a></li>
