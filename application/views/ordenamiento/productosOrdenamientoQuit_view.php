...
<script>
    ...
    function guardar()
    {
          ...
          $.ajax({
				        ...
				        url:"<?= site_url('Ordenamiento/guardarCambiosProductosQuitOrdenamiento') ?>",
				        async: true,
    ...
    function regresar()
    {
         swal({
                                  ...
                                  function(isConfirm)
                                {
                                    ...
                                    {
                                      //  location.reload();
                                           parent.location.href="<?php echo base_url();?>index.php/Ordenamiento/PromocionVaciarSesionDesactivar";
                                    } else
                                    {
                                       // location.reload();
                                    }
