  ...
  function enviarDatos()
        {
            if($('#TextBuscar').val()!='')
            {
				...
				url:"<?php echo base_url().'index.php/Ordenamiento/verificarBusquedaAddOrdenamiento'; ?>",
				async: false,
    ...
    sweetAlert('Error', 'Necesitas ingresar un codigo', 'error');
      ...
      function construirTabla()
      {
           $.ajax({
                    ...
                    url:"<?php echo base_url().'index.php/Ordenamiento/busquedaProductosAddOrdenamiento'; ?>",
                    async: true,
                    success: function(response)
                    {
