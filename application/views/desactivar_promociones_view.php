        ...
        <form id="productosPromocion" method="post">
            ...
            <tr id="row<?php echo($i) ?>">
                ...
                <td style="width:10px;">
                    ...
                    <label class="switch switch-success"><input type="checkbox" id="folio<?php echo($i + 1) ?>"
                                                                name="productos[]"
    ...
    <script>
         ...
         $('#productosFiltro').click(function() {
                    ...
                    if ($('input[type="checkbox"]').is(':checked')) {
                        ...
                        $('#productosPromocion').attr("action","<?php echo base_url();?>index.php/Promociones/crearFiltradoProductosDesactivar");
                    }
                    else {
                     //  alert('vacio');
