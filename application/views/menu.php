      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo"><b><?php echo date("d-m-Y");?></b></a>
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="<?php echo base_url(); ?>">Regresar</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
...
<!--              	  <p class="centered"><a href=""><img src="<?php echo base_url();?>assets/img/dashboard/"  width="130px"></a></p>-->
              	  <h5 class="centered"><?php echo $this->session->userdata('nameUser');?></h5>
