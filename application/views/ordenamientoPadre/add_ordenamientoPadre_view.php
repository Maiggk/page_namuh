...
<script type="text/javascript">
    ...
    {
        parent.location.href="<?php echo base_url();?>index.php/OrdenProductos/ordenAparicionPadre";
    }
    ...
    function verificarValorOrdenamiento()
    {
        $.ajax({
           ...
           url:"<?= site_url('OrdenProductos/verificarValorOrdenamientoPadre') ?>",
           async: true,
           success: function(response)
           {
               ...
               {
                    swal({
                    title: "El número de ordenamiento ya esta en uso ¿Desea continuar? ",
                    text: "",
                    type: "success",
                    showCancelButton: true,
                    confirmButtonColor: "#656668",
    ...
    function AddOrdenamiento()
    {
       $.ajax({
           ...
           url:"<?= site_url('OrdenProductos/AddOrdenamientoPadre') ?>",
           async: true,
           success: function(response)
           {
                  parent.location.href="<?php echo base_url();?>index.php/OrdenProductos/ordenAparicionPadre";
