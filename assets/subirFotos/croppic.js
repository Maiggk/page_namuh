	...
	Croppic.prototype = {
				    ...
				    if (typeof FileReader == "undefined"){
						...
						reader.onload = function (e) {
							...
							image.onload = function(){
								...
								that.obj.append('<img id="foto" src="'+image.src+'">');
		...
		loadExistingImage: function(){
			...
			if( $.isEmptyObject(that.croppedImg)){
				...
				var img =$('<img id="foto" src="'+ that.options.loadPicture +'">');
				that.obj.append(img);
				img.load(function() {
		...
		afterUpload: function(data){
            ...
            if (response.status == 'success') {
                ...
                var img = $('<img id="foto" src="'+response.url+'">')
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.obj.append('<img id="foto" class="croppedImg" src="' + response.url + '">');
