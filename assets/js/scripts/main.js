...
theme.events.push(theme.slider.init);
// end slitslider module


// search bar module
theme.searchButton = function() {
    var h = '54px';
...
theme.events.push(theme.searchButton);
// end search bar module


// pie chart module
theme.pieChart = function(obj){
    var time = 1500;
...
theme.events.push(theme.pieChart);
// end pie chart module

// slider control module
theme.sliderControl = function(){
...
theme.events.push(theme.sliderControl);
// end slider control module


// accordion icons module
theme.accordionIcon = function(){
    var
...
theme.events.push(theme.accordionIcon);
// end accordion icons module


// scroll effects module
theme.scrollController = function() {
    var
    ...
    if ($parallax.length > 0) {
        var testMobile = theme.isMobile.any();
        if (testMobile === null) {
...
theme.events.push(theme.scrollController);
...
theme.events.push(theme.isotope);
// end isotope module


// google maps module
theme.gmaps = function(){
    var
        $elem = $('#map-canvas'),
        options = window.mapOptions || {},
        apiLoad = function() {
            $.getScript('https://maps.googleapis.com/maps/api/js?v=3.exp&callback=theme.gmaps')
...
theme.events.push(theme.portfolio);
...
theme.events.push(theme.contactForm);
